...
import logo from '../HomePage/11.svg';
    ...
    return (
      <div className="pop-content">
        <div className="pop-content-container">
          <span>
            <Link to="/new-story">TULISLAH</Link>
          </span>
          <span>
            <Link to={'/me/stories'}>PUBLIKASI</Link>
          </span>
          <span>
            <Link to={'/me/lists'}>DAFTAR ISI</Link>
          </span>
          <span>
            <a
              href="https://doc.median.fun"
              target={'_blank'}
